...
public class L2LAIterativePartitioner implements PartitioningDriver {
	private int nParts;
	private long l1Size;

	public L2LAIterativePartitioner()
	{
		nParts=-1;
	}
	...
	public int getNparts(Distribution<?>[] distrs, HierarchyLevel hierarchy,SOMDTask<?> task) {
		HierarchyLevel l1 = hierarchy.getLevel(HierarchyLevel.L2);
