package javaGrande.multithreaded.section1;

import javaGrande.multithreaded.jgfutil.JGFInstrumentor;
import javaGrande.multithreaded.jgfutil.JGFSection1;
...
public class JGFBarrierBench implements JGFSection1{
  ...
  public void JGFrun(){
	...
	th[i].start();
      ...
      JGFInstrumentor.addOpsToTimer("Section1:Barrier:Simple",(double) size);  
      size *=2;
    }
    ...
    while (time < TARGETTIME && size < MAXSIZE){
      ...
      JGFInstrumentor.addOpsToTimer("Section1:Barrier:Tournament",(double) size);
      size *=2;
    }
