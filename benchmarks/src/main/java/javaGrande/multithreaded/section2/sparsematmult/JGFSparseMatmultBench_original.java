...
package javaGrande.multithreaded.section2.sparsematmult;
import java.util.Random;

import javaGrande.multithreaded.jgfutil.JGFInstrumentor;
import javaGrande.multithreaded.jgfutil.JGFSection2;

public class JGFSparseMatmultBench_original extends SparseMatmult implements JGFSection2{ 
  ...
  public JGFSparseMatmultBench_original(int nthreads) {
