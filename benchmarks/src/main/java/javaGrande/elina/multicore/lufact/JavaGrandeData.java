...
public class JavaGrandeData {
	...
	static int sizes[] = { 
			500, 1000, 2000 // reference JavaGrande configurations (A, B, C)
		};
	...
	final int n, lda, ldaa;
	int info;
	int ipvt[];

	JavaGrandeData(int probClass) {
	...
	final static double abs(double d) {
		return (d >= 0) ? d : -d;
	}

	static final double matgen(double a[][], int lda, int n, double b[]) {
		double norma;
		int init, i, j;
	 ...
	 * blas daxpy,ddot
	 */
	static final void dgesl(double a[][], int lda, int n, int ipvt[], double b[],
			int job) {
		double t;
		int k, kb, l, nm1, kp1;
	 ...
	 */
	static final void daxpy(int n, double da, double dx[], int dx_off,
	 ...
	 */
	static final double ddot(int n, double dx[], int dx_off, int incx, double dy[],
			int dy_off, int incy) {
		double dtemp;
		int i, ix, iy;
	 ...
	 */
	static final void dscal(int n, double da, double dx[], int dx_off, int incx) {
		int i, nincx;
	 ...
	 * linpack, 3/11/78.
	 */
	static final int idamax(int n, double dx[], int dx_off, int incx) {
		double dmax, dtemp;
		int i, ix, itemp = 0;
	 ...
	 */
	static final double epslon(double x) {
		double a, b, c, eps;
	 ...
	 */
	static final void dmxpy(int n1, double y[], int n2, int ldm, double x[],
			double m[][]) {
		int j, i;
