...
/**
 * Retrieved fron JavaGrande Crypt Benchmark
 * 
 * Adapted by: Diogo Mourao and Joao Saramago
 *
 */

public class CryptTask extends SOMDTask<Void> {
	...
	public CryptTask(int[] keyE, int[] keyD, byte[] text1,byte[] text2) {
		this.keyE = keyE;
		this.keyD=keyD;
		this.text1=text1;
		this.text2=text2;
	...
	public Void call(Object[] partition) {
		encryptOrDecrypt(keyE, partition);
		encryptOrDecrypt(keyD, partition);
		return null;
	}
	
	private void encryptOrDecrypt(int[] key, Object[] partition)
	{
