...
public class StencilDistInner2D extends AbstractDistribution<int[][]> {
	...
	public StencilDistInner2D(int rows, int cols, int numberOfElementsPerPartition, int elementarySize, int k) {
	...
	public float getAveragePartitionSize(int nParts) {
		...
		return (rows/sqrt-2*k)*(cols/sqrt-2*k);
	}
